      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
        <div className="col-span-2 lg:col-span-1 space-y-4">
          ...
          <div className="flex space-x-4 pt-2">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition flex items-center">
            ...
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition flex items-center">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
        ...
        <div>
          <h4 className="text-white uppercase tracking-widest font-semibold mb-4 text-[10px]">Brand Locations</h4>
          <p className="text-zinc-500 normal-case mb-2 leading-relaxed">
            <strong>Corporate & Studio:</strong> Sector 62, Noida, UP, India
          </p>
          <p className="text-zinc-500 normal-case leading-relaxed">
            <strong>Delhi Studio:</strong> Greater Kailash 1, New Delhi, DL, India
          </p>
        </div>
      </div>
